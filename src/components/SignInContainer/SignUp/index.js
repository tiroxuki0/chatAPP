...
export default React.memo(function SignUp({ toastNotify }) {
  ...
  return (
    <>
      ...
      >
        <img src={signUp} style={{ width: "55px", height: "55px" }} alt="sign-up logo" />
        <Typography component="h1" variant="h5" sx={{ mt: 1 }}>
          Create An Account
        </Typography>
        <p style={{ color: "rgb(182 182 182)", margin: "10px 0px 20px 0px" }}>Get your free account now.</p>
          ...
          <Grid container spacing={"10px"}>
            <Grid item xs={12}>
              <TextValidator
                ...
                errorMessages={["Please enter display name", "Display name must be at least 10 characters long"]}
              />
            </Grid>
            <Grid item xs={12}>
              <TextValidator
                ...
                errorMessages={["Please enter email", "Email is not valid!", "Email must be at least 8 characters long"]}
              />
            </Grid>
            <Grid item xs={12}>
              <TextValidator
